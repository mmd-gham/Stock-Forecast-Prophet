...
stock = pd.read_csv("D:\mohammad\Python\Stock Market prediction\stock")
stock.drop(['High','Low','Volume','nas_Volume','nas_Open','nas_High','nas_Low','gold_Close','Treasury_Close','FedFunds','UNemploy'], inplace= True, axis= 1)
...
# df.drop(["Open",'nas_Close','CPI','GDP'], axis= 1, inplace = True)
